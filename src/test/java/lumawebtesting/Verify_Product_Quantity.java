...
public class Verify_Product_Quantity
{
public WebDriver dr;
	...
	public void Product_Quantity() throws InterruptedException
	{
		...
		dr.findElement(By.xpath("//div[@id='option-label-size-143-item-167']")).click();
		dr.findElement(By.xpath("//div[@id='option-label-color-93-item-56']")).click();
		dr.findElement(By.id("qty")).sendKeys("41");
		...
		// verify product is displayed in cart with no of quantity
		
		String Quantity=dr.findElement(By.id("cart-718867-qty")).getText();
		assertEquals(Quantity,"41");
